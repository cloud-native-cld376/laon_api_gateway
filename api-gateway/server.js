...
const LOGIN_SERVICE = process.env.LOGIN_SERVICE || 'http://localhost:3004';
const LOAN_SERVICE = process.env.LOAN_SERVICE || 'http://localhost:3002';
const ADMIN_SERVICE = process.env.ADMIN_SERVICE || 'http://localhost:3003';
